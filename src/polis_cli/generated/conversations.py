...
def update_conversations_update(
    ...
    is_active: Optional[bool] = typer.Option(None, "--is-active", help="true = open for voting, false = closed"),
    ...
    vis_type: Optional[int] = typer.Option(None, "--vis-type", help="0 = participants do not see the opinion-group visualisation, 1 = they do"),
    help_type: Optional[int] = typer.Option(None, "--help-type", help="0 = hide the explanation text above voting, 1 = show it"),
    write_type: Optional[int] = typer.Option(None, "--write-type", help="0 = participants cannot add statements (fixed ballot), 1 = they can"),
    ...
    subscribe_type: Optional[int] = typer.Option(None, "--subscribe-type", help="0 = no subscribe-by-email prompt after voting, 1 = show it"),
